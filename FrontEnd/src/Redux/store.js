...
import {reducer as MohanLocalReducer} from "./MohanReduxLocal/reducer"
import thunk from "redux-thunk"

const rootReducer = combineReducers({Package, Packagetype,City,CouponReducer,AdminReducer,MohanLocalReducer});
